...
# seg2333/seg25ab the FP-emulator, seg2608 the whole DGROUP.  CL/EMU/MATHL are
# still on the link line as a safety net — TLINK only pulls what is unresolved.
...
for s in seg0000 seg2333 seg25ab seg1a3f seg1a88 seg1c64 seg1c75 seg2286 seg2608; do
...
ACTOR CREATURE GAME GAMEMGR GUI KBD MENU SCORES TILEMAP UTIL VGADISP"
